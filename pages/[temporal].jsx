        ...
        formViewer === true && <div className={`relative h-screen bg-black ${styles.viewer}`}>
...

          {
            ...
            <div className='relative '>
              ...
              {
                userDB[validate()].Posts[`PostImage_${router.query.temporal.slice(2)}`].whatsapp && userDB[validate()].Posts[`PostImage_${router.query.temporal.slice(2)}`].whatsapp !== undefined && userDB[validate()].Posts[`PostImage_${router.query.temporal.slice(2)}`].whatsapp !== '' && <Link href={`https://api.whatsapp.com/send?phone=${userDB[validate()].Posts[`PostImage_${router.query.temporal.slice(2)}`].whatsapp}&text=Hola%20vi%20su%20anuncion%20en%20el%20PERIODICO%20HOY%20`} className='z-50' legacyBehavior>
